...
<script lang="ts">
  ...
  import { serviceNodeFormSchema } from '/@/views/servicemanage/serviceroute/data';
  ...
  export default defineComponent({
    ...
    setup(_, { emit }) {
      ...
      function modify(model: any, callback: Function) {
        model.serviceId = unref(parentId);
      ...
      const getTitle = computed(() => (!unref(isUpdate) ? '新增服务节点' : '编辑服务节点'));
